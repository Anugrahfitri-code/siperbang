...
# Test spesifik
php artisan test tests/Feature/Receipt/ReceiptDocumentTest.php
...
1. `routes/web.php` dan `routes/api.php` — pemisahan route web dan API
...
5. `app/Services/Inventory/ExcelPersediaanImportService.php` — logika impor Excel
6. `app/Jobs/Receipt/ProcessReceiptOcr.php` — cara queue OCR bekerja
7. `resources/js/App.tsx` — entry point React + routing
8. `resources/js/shared/api.ts` — helper pemanggilan API frontend
