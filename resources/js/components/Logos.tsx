...
export const SiperbangLogo: React.FC<{ className?: string; iconOnly?: boolean; lightText?: boolean }> = ({
  className = "",
  iconOnly = false,
  lightText = false,
}) => {
    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      {!iconOnly && (
        <div className="flex flex-col select-none">
          ...
          <span className={`text-[10px] font-medium tracking-wide mt-1 leading-none uppercase ${lightText ? 'text-indigo-200' : 'text-[#7A7A7A]'}`}>
