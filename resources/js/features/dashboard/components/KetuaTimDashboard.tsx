...
import { ItemRequest, RequestStatus } from "../../../shared/types";
import {
  FileText,
  Clock,
  RefreshCw,
    ...
    <div className="space-y-6">
      ...
      <div className="relative bg-gradient-to-r from-[#f8faff] to-[#f0f4ff] rounded-2xl border border-indigo-50/50 p-6 shadow-sm overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <button
          onClick={onRefresh}
          disabled={loading}
          className="relative z-10 flex items-center gap-2 px-4 py-2.5 rounded-xl border border-indigo-100 text-xs font-bold text-indigo-600 bg-white hover:bg-indigo-50 transition-colors shadow-sm self-start md:self-auto disabled:opacity-50"
        >
