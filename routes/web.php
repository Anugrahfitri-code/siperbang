...
use App\Http\Controllers\Web\StokUploadController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/master-barang/search', [BarangController::class, 'search'])->name('master-barang.search');
    Route::post('/master-barang/{id}/update', [BarangController::class, 'update'])->name('master-barang.update');
    Route::post('/master-barang/{id}/delete', [BarangController::class, 'destroy'])->name('master-barang.destroy');
});
