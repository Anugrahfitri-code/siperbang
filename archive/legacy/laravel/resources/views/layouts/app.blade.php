                ...
                <div class="flex items-center gap-8">
                    <a href="/" class="flex items-center gap-2">
                        <div class="relative w-12 h-12 flex-shrink-0">
                            <img
                                src="{{ asset('images/brand/siperbang-logo.png') }}"
                                alt="Logo SIPERBANG"
                    ...
                    <div class="hidden md:flex items-center gap-2">
                        <div class="relative w-9 h-9 flex-shrink-0">
                            <img src="{{ asset('images/brand/komdigi-logo.png') }}" alt="Logo KOMDIGI" class="w-full h-full object-contain select-none pointer-events-none">
                        </div>
                      <div class="flex flex-col select-none text-left">
